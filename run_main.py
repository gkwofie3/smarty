...
def main():
    icon_path = get_asset_path('main/public/logo.png')
    window = webview.create_window('Smarty Main', 'http://localhost:5001', icon=icon_path)
    ...
    window.expose(Api())
    # window.events.loaded += on_loaded # Sometimes unreliable, better to just expose and use
