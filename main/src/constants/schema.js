    ...
    "elements": [
        {
            "name": "Line",
            "properties": [
                "start_x", "start_y", "end_x", "end_y", "stroke_color", "stroke_width", "stroke_style", "arrow_start", "arrow_end", "rotation_angle", "visibility_condition", "enabled_condition", "z_index", "opacity", "tooltip_text", "name_id", "custom_metadata", "animation_speed", "binding_source", "security_level", "audit_trail_enabled"
            ]
        },
        {
            "name": "Rectangle",
            "properties": [
                "x_position", "y_position", "width", "height", "fill_color", "border_color", "border_width", "border_style", "corner_radius", "rotation_angle", "visibility_condition", "enabled_condition", "z_index", "opacity", "tooltip_text", "name_id", "custom_metadata", "shadow_color", "shadow_offset", "gradient_fill", "animation_type", "binding_source", "security_level", "audit_trail_enabled", "event_on_click", "event_on_hover"
            ]
        },
        {
            "name": "Ellipse/Circle",
            "properties": [
                "x_position", "y_position", "width", "height", "fill_color", "border_color", "border_width", "border_style", "rotation_angle", "visibility_condition", "enabled_condition", "z_index", "opacity", "tooltip_text", "name_id", "custom_metadata", "shadow_color", "shadow_offset", "gradient_fill", "animation_type", "binding_source", "security_level", "audit_trail_enabled", "start_angle", "end_angle", "event_on_click"
            ]
        },
        {
            "name": "Polygon",
            "properties": [
                "points_list", "fill_color", "border_color", "border_width", "border_style", "rotation_angle", "visibility_condition", "enabled_condition", "z_index", "opacity", "tooltip_text", "name_id", "custom_metadata", "shadow_color", "shadow_offset", "gradient_fill", "animation_type", "binding_source", "security_level", "audit_trail_enabled", "event_on_click"
            ]
        },
        {
            "name": "Arc",
            "properties": [
                "x_position", "y_position", "width", "height", "start_angle", "end_angle", "stroke_color", "stroke_width", "stroke_style", "rotation_angle", "visibility_condition", "enabled_condition", "z_index", "opacity", "tooltip_text", "name_id", "custom_metadata", "animation_speed", "binding_source", "security_level", "audit_trail_enabled"
            ]
        },
        {
        ...
        },
        {
            ...
            "properties": [
                "x_position", "y_position", "width", "height", "target_url_or_screen", "label_text", "font_family", "font_size", "font_color", "underline", "rotation_angle", "visibility_condition", "enabled_condition", "z_index", "opacity", "tooltip_text", "name_id", "custom_metadata", "open_in_new_window", "security_level", "audit_trail_enabled"
            ]
        },
        {
            "name": "Snippet",
