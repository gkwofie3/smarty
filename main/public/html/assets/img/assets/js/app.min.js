...
<a class="navbar-link dropdown-toggle icon" data-bs-toggle="dropdown" href="app.min.js">
...
<a class="navbar-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown" href="app.min.js">
...
<div class="app-sidebar-mobile-backdrop"><a class="stretched-link" data-dismiss="app-sidebar-mobile" href="app.min.js"></a></div>
<!-- END #sidebar -->
<!-- BEGIN #content -->
...
<a class="btn btn-dark me-2 text-truncate" href="app.min.js" id="daterange-filter">
...
<a class="widget-list-item rounded-0 pt-3px" href="app.min.js">
...
<!-- BEGIN widget-list-item -->
<a class="widget-list-item" href="app.min.js">
<div class="widget-list-media icon">
...
<!-- END widget-list-item -->
<!-- BEGIN widget-list-item -->
<a class="widget-list-item pb-3px rounded-bottom" href="app.min.js">
<div class="widget-list-media icon">
...
<a class="btn btn-xs btn-indigo fs-10px ps-2 pe-2" href="app.min.js">View campaign</a>
</div>
<!-- END col-8 -->
</div>
<!-- END row -->
...
<a class="btn btn-xs btn-warning fs-10px ps-2 pe-2" href="app.min.js">View campaign</a>
</div>
<!-- END col-8 -->
</div>
<!-- END row -->
