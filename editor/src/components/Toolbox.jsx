...
const Toolbox = () => {
    ...
    const categories = {
        ...
        'Media': ['Static Image', 'Video Player', 'Web View', 'Icon'],
        'Controls': ['Push Button', 'Toggle Button/Switch', 'Slider', 'Knob', 'Text Input', 'Number Input', 'Increase Button', 'Decrease Button'],
        'Gauges & Charts': ['Vertical Gauge', 'Horizontal Gauge', 'Circular Gauge', 'Bar Chart', 'Pie Chart', 'Donut Chart'],
        'Lists & Tables': ['Data Table', 'Alarm Table', 'Event Table', 'Log Table', 'Fault Table'],
        'Others': ['Hyperlink/Goto Tag']
    };
